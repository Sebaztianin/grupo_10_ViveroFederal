...
if (prevPage.getAttribute("href") == 0) {
    ...
    if (querystring) {
        prevPage.setAttribute('href', '/categories/panel?page=' + prevPage.getAttribute("href") + '&' + querystring);
    } else {
        prevPage.setAttribute('href', '/categories/panel?page=' + prevPage.getAttribute("href"));
    }
...
if (nextPage.getAttribute('href') == 0) {
    ...
    if (querystring) {
        nextPage.setAttribute('href', '/categories/panel?page=' + nextPage.getAttribute("href") + '&' + querystring);
    } else {
        nextPage.setAttribute('href', '/categories/panel?page=' + nextPage.getAttribute("href"));
    }
