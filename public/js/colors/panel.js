...
if (prevPage.getAttribute("href") == 0) {
    ...
    if (querystring) {
        prevPage.setAttribute('href', '/colors/panel?page=' + prevPage.getAttribute("href") + '&' + querystring);
    } else {
        prevPage.setAttribute('href', '/colors/panel?page=' + prevPage.getAttribute("href"));
    }
...
if (nextPage.getAttribute('href') == 0) {
    ...
    if (querystring) {
        nextPage.setAttribute('href', '/colors/panel?page=' + nextPage.getAttribute("href") + '&' + querystring);
    } else {
        nextPage.setAttribute('href', '/colors/panel?page=' + nextPage.getAttribute("href"));
    }
